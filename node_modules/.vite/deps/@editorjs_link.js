//#region node_modules/@editorjs/link/dist/link.mjs
(function() {
	"use strict";
	try {
...
(function(k) {
	var w = function() {
		...
		var n = function(e) {
			...
			var s = typeof e;
			if (s !== "undefined") if (s === "string") e !== "" && this._fromString(e);
			else if (e instanceof n) {
				var h = this;
				e.forEach(function(u, f) {
					h.append(f, u);
				});
			} else if (e !== null && s === "object") if (Object.prototype.toString.call(e) === "[object Array]") for (var t = 0; t < e.length; t++) {
				var y = e[t];
			...
			origin: {
				get: function() {
					var l = {
						...
						"https:": 443,
						"ftp:": 21
					}[this._anchorElement.protocol], n = this._anchorElement.port != l && this._anchorElement.port !== "";
			...
			function(d, v, c) {
				...
				var a, p, l, n, o, e, s = c(8), h = (p = function(t) {
					return new Promise(function(y, r) {
						...
						u.upload.addEventListener("progress", function(m) {
							...
							if (u.readyState === 4) {
								...
								var b = s.parseHeaders(u.getAllResponseHeaders()), g = {
									body: m,
									code: u.status,
									headers: b
								};
					...
					switch (arguments.length > 1 ? arguments[1] : void 0) {
						case a.URLENCODED: return s.urlEncode(t);
						case a.JSON: return s.jsonEncode(t);
						case a.FORM: return s.formEncode(t);
						default: return t;
					}
				}, {
					contentType: a = {
			...
			function(d, v) {
				var c = function(a) {
					...
					return p = p || null, l = l || "&", n = n || null, a ? function(o) {
						...
						var e, s, h = o;
						if (n && (h = n + "[" + h + "]"), typeof a[o] == "object" && a[o] !== null) e = i(a[o], null, l, h);
						else {
