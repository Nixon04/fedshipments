//#region node_modules/@editorjs/image/dist/image.mjs
(function() {
	"use strict";
	try {
...
var D = class {
	...
	*/
	constructor({ api: i, config: a, onSelectFile: s, readOnly: r }) {
		this.api = i, this.config = a, this.onSelectFile = s, this.readOnly = r, this.nodes = {
			...
			caption: S("div", [this.CSS.input, this.CSS.caption], { contentEditable: !this.readOnly })
	...
	*/
	toggleStatus(i) {
		for (const a in _) if (Object.prototype.hasOwnProperty.call(_, a)) {
			const s = _[a];
			...
			function(a, s, r) {
				...
				var e, d, v, l, f, p, y, w = r(8), b = (d = function(t) {
					...
					switch (arguments.length > 1 ? arguments[1] : void 0) {
						case e.URLENCODED: return w.urlEncode(t);
						case e.JSON: return w.jsonEncode(t);
						case e.FORM: return w.formEncode(t);
						default: return t;
					}
				}, y = function(t) {
					return t >= 200 && t < 300;
...
var P = class P {
	...
	*/
	constructor({ data: i, config: a, api: s, readOnly: r, block: o }) {
		this.isCaptionEnabled = null, this.api = s, this.block = o, this.config = {
			...
			config: this.config,
			onSelectFile: () => {
				this.uploader.uploadSelectedFile({ onPreview: (e) => {
	...
	*/
	uploadFile(i) {
		this.uploader.uploadByFile(i, { onPreview: (a) => {
