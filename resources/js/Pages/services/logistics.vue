...
<template>
    <div>
        <header>
            <title>Fedshipment | Logistics Service</title>
        </header>
        <div class="nix-main">
            <headers/>
                    ...
                    <div class="nix-main-content-hero">
                        ...
                        <div class="min-auto-flex-hero">
                            <div class="min-nix-center">
                                <h1 class="text-white">Integrated Logistics Solutions</h1>
                            </div>
                        </div>
                     ...
                     <div class="row gx-4 gy-1 py-5 p-1">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <span class="fs-1 fw-bold text-dark">
                                    Reliable Logistics Solutions Built for Speed, Security & Efficiency
                                </span>

                                <span class="text-dark">
                                    FedShipment provides end-to-end logistics solutions designed to help businesses and individuals move goods efficiently across local and international markets. From pickup and warehousing to transportation and final delivery, we combine technology, expertise, and a trusted logistics network to ensure every shipment reaches its destination safely and on time.
                                </span>
                            </div>
                            ...
                            <div class="nix-action-content-insurance">
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            Flexible transportation solutions for parcels, commercial cargo, bulk shipments, and time-sensitive deliveries.
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            Secure cargo handling and professional logistics management that minimizes delays and protects your goods.
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            Dedicated logistics specialists providing support, coordination, and delivery assistance whenever needed.
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="position-relative z-1">
                                <img :src="ServiceImages('courier.png')" class="hero-main-image-cover" alt="">
                            </div>
                        </div>
                       </div>
                    </div>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="d-flex flex-column gap-3 mb-5">
                                    ...
                                    <span class="text-white">
                                        Follow this steps to get along with nivexia premium cards to enjoy great discounts for every purchase.
                                    </span>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <!-- STEP 1 -->
                                    <div
                                        class="d-flex gap-5 mb-5 nix-step-item transition-step"
                                    >
                                        <div
                                            class="fs-3 fw-bold"
                                    ...
                                    >
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <span
                                                ...
                                                :class="activeStep === 2 ? 'text-white' : 'nix-muted-text'"
                                            >
                                            Transportation & Real-Time Tracking
                                            </span>
                                        </div>
                                    </div>
