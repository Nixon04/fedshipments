...
<template>
    <div>
        <header>
            <title>Fedshipment | Ocean Freight Service</title>
        </header>
        <div class="nix-main">
            <Headers/>
                    ...
                    <div class="nix-main-content-hero">
                        ...
                        <div class="min-auto-flex-hero">
                            <div class="min-nix-center">
                                <h1 class="text-white">Ocean Freights</h1>
                            </div>
                        </div>
                     ...
                     <div class="row gx-4 gy-1 py-5 p-1">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <span class="fs-1 fw-bold text-dark">
                                    Global Ocean Freight Solutions for Reliable International Shipping
                                </span>

                                <span class="text-dark">
                                    FedShipment provides dependable ocean freight services that connect businesses and individuals to global markets. Whether you're shipping full container loads, consolidated cargo, commercial goods, or oversized freight, our extensive maritime network ensures cost-effective and secure transportation across international trade routes. We handle every stage of the process, from documentation and customs coordination to final delivery.
                                </span>
                            </div>
                            ...
                            <div class="nix-action-content-insurance">
                                <div class="d-flex flex-column gap-1">
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            Access major international shipping routes through trusted carrier partnerships worldwide.
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            Flexible shipping options including Full Container Load (FCL) and Less than Container Load (LCL).
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            End-to-end cargo management with customs documentation and compliance support.
                                        </span>
                                    </div>
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        ...
                                        <span class="text-dark">
                                            Cost-efficient transportation solutions for commercial, industrial, and retail cargo.
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="position-relative z-1">
                                <img :src="ServiceImages('cargos.png')" class="hero-main-image-cover" alt="">
                            </div>
                        </div>
                       </div>
                    </div>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="d-flex flex-column gap-3 mb-5">
                                    ...
                                    <span class="text-white">
                                        Our streamlined ocean freight process ensures your cargo moves safely and efficiently across international waters.
                                    </span>
                                </div>
